...
{!! Html::script('js/sale_edit.js', array('type' => 'text/javascript')) !!}
            ...
            <div class="panel-body">
                ...
                <div class="row" ng-controller="SearchItemCtrl">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            {!! Form::model($sale, array('route' => array('sales.update', $sale->id), 'method' => 'PUT', 'files' => true)) !!}
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        {!! Form::select('customer_id', $customers, null, array('class' => 'form-control', 'id' => 'customer_id', 'readonly')) !!}
                                        </div>
                                    </div>
                                     <div>&nbsp;</div>
                                    <div class="form-group">
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>@{{newsaletemp.item_id}}</td><td>@{{newsaletemp.item.item_name}}</td><td>Rp <input type="text"  autocomplete="off" name="selling_price" ng-change="updateSaleTemp(newsaletemp)" ng-model="newsaletemp.selling_price" size="15" value="@{{newsaletemp.selling_price}}">
                            </td><td><input type="text" style="text-align:center" autocomplete="off" name="quantity" ng-change="updateSaleTemp(newsaletemp)" ng-model="newsaletemp.quantity" size="2"></td><td>@{{newsaletemp.selling_price * newsaletemp.quantity | currency: "Rp "}}</td><td><button class="btn btn-danger btn-xs" type="button" ng-click="removeSaleTemp(newsaletemp.id)"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></td>
                            </tr>
                        </table>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        {!! Form::select('is_dropshipper', array('0'=>'No', '1' => 'Yes'), null, array('class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                    <div>&nbsp;</div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        {!! Form::text('no_resi', null, array('class' => 'form-control', 'id'=>'no_resi')) !!}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                             {!! Form::hidden('original_shipping_price', $sale->shipping_price, array('class' => 'form-control', 'id'=>'original_shipping_price')) !!}
                                             {!! Form::text('shipping_price', null, array('class' => 'form-control', 'ng-model' => 'shipping_price', 'id'=>'shipping_price')) !!}
...
<script type="text/javascript">
  ...
  //  $('#shipping_price').attr("value", {{$sale->shipping_price}});
