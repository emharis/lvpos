		...
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
                    ...
                    <label class="radio-inline"><input type="radio" name="dropshipper" value="1">Yes</label>
                    <label class="radio-inline"><input type="radio" name="dropshipper" value="0" checked>No</label>
                    </div>
                    <div class="form-group">
                    {!! Form::label('store_id', 'Source') !!}
                    {!! Form::select('store_id', $stores, Input::old('store_id'), array('class' => 'form-control')) !!}
                    </div>

					{!! Form::submit('Submit and Create PO', array('class' => 'btn btn-primary')) !!}
