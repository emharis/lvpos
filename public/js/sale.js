(function(){
    ...
    app.controller("SearchItemCtrl", [ '$scope', '$http', function($scope, $http) {
        ...
        $scope.updateSaleTemp = function(newsaletemp) {
            ...
            $http.put('../api/saletemp/' + newsaletemp.id, { quantity: newsaletemp.quantity, selling_price: newsaletemp.item.selling_price, total_cost: newsaletemp.item.cost_price * newsaletemp.quantity,
